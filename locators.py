...
class SBISContactsLocators():
    ...
    LIST_PARTNERS = (By.CSS_SELECTOR, "#contacts_list > div > div.ws-flexbox.sbisru-Contacts-City__flex.sbisru-Contacts-Shot")
    REGION_KAMCHAT_KRAI = (By.CSS_SELECTOR, "#popup > div.controls-Popup.ws-float-area-show-complete.controls-Popup_shown.controls_themes__wrapper.controls-Scroll_webkitOverflowScrollingTouch.controls-Popup__lastItem > div > div > div > div > div.sbis_ru-Region-Panel.sbis_ru-Region-Panel-l > div > ul > li:nth-child(43) > span > span")
